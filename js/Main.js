...
var GmailBox = React.createClass({
 ...
 gmailLogin: function()
 {
   ...
   var CLIENTID    =   '1008496746598-vr9glmi0op05i06eag5bb6h0rji0vsa2.apps.googleusercontent.com';
 ...
 allLabels: function()
 {
     ...
     $.ajax({
      url: 'https://www.googleapis.com/gmail/v1/users/me/labels?key={AIzaSyAn3yt87rfMksU_vRr3Vg3balpzi587Buw}',
      dataType: 'json',
      type: 'GET',
 ...
 render:function()
 {
   ...
   if(loadedData){
     leftPanel =  <SideBarComponent labels={this.state.allLabelsData}/>
